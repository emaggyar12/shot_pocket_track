...
if __name__ == '__main__':
    player_track = PlayerTracker('/Users/anirudhhaharsha/Desktop/Sports Analytics Projects/Basketball/shot_body_location/premade/basketball_analysis/models/ball_detector_model.pt')
    print(player_track.model.names)
